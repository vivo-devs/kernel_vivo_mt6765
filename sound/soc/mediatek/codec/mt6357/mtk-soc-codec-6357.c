...
/*BSP.Audio - 2021.06.28 - modify for bring up PA*/
			       ...
			       struct snd_ctl_elem_value *ucontrol)
{
	...
	if ((ext_spk_mode == AW87XXX_MUSIC_MODE) || (ext_spk_mode == AW87XXX_VOICE_MODE) || (ext_spk_mode == AW87XXX_FM_MODE)) {
		aw87xxx_audio_scene_load(ext_spk_mode, AW87XXX_LEFT_CHANNEL);
