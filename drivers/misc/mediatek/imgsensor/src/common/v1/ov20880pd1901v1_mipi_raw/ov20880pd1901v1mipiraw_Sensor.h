 ...
 *
 ****************************************************************************/
#ifndef _OV20880PD1901V1MIPI_SENSOR_H
#define _OV20880PD1901V1MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom1;	//custom5 scenario relative information
	struct imgsensor_mode_struct custom2;	//custom5 scenario relative information
	struct imgsensor_mode_struct custom3;	//custom5 scenario relative information
	struct imgsensor_mode_struct custom4;	//custom5 scenario relative information
