...
#define VIVO_MAIN3_VENDOR_LENS_ID2 0x07
...
int vivo_main3_otp_read_ov8856(void)
{
	...
	if (check_if_group_valid == 0x01) { /****all the data is valid****/
		...
		if (  (VIVO_MAIN3_VENDOR_TRULY != main3_otp_data_ov8856[0x01]) && (main3_otp_data_ov8856[0x01] != VIVO_MAIN3_VENDOR_SUNNY)) {
			...
			return 0;
		} else if ((((VIVO_MAIN3_VENDOR_LENS_ID != main3_otp_data_ov8856[0x0008])) && ((VIVO_MAIN3_VENDOR_LENS_ID2 != main3_otp_data_ov8856[0x0008]))) || (VIVO_MAIN3_VENDOR_VCM_ID != main3_otp_data_ov8856[0x0009]) || (VIVO_MAIN3_VENDOR_DRIVERIC_ID != main3_otp_data_ov8856[0x000A]) || (VIVO_MAIN3_VENDOR_PLATFORM_ID != main3_otp_data_ov8856[0x0002])) {
			MAIN3_OTP_ERROR_CODE_OV8856 = OTP_ERROR_CODE_MODULE_INFO_ERROR;
