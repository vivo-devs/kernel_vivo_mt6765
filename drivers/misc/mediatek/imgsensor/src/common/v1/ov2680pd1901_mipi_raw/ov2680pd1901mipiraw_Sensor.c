...
#include "ov2680pd1901mipiraw_Sensor.h"
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_CUSTOM_INFO:
		printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_OTP_ERROR_CODE_OV2680PD1901:%d \n", *feature_data);
            switch (*feature_data) {
...
UINT32 OV2680PD1901MIPISensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV2680PD1901_MIPI_RAW_SensorInit	*/
