...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{ 1600, 1200,  160,  120, 1280,  960, 1280,  960,  0000, 0000, 1280,  960, 	     0,    0, 1280,   960},  //custom2
};
...
#if defined(CONFIG_MTK_CAM_PD1987)
	if(gpio173_value == 0){
		write_cmos_sensor_8_8(0xfe,0x03);
		write_cmos_sensor_8_8(0x02,0x35);	
	}
#endif
...
/*const kal_uint8 i2c_addr[] = {IMGSENSOR_WRITE_ID_1, IMGSENSOR_WRITE_ID_2};*/
	...
	gpio173_value = gpio_get_value(GPIO173);
	if(gpio173_value == 1)
		printk("this board is PD1987");
	else
		printk("this board is PD1987IF");
#endif	
