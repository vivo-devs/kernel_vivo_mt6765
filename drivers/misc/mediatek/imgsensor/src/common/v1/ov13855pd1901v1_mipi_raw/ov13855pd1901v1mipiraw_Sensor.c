 ...
 *============================================================================
 ****************************************************************************/
#define PFX "OV13855PD1901V1_camera_sensor"
...
#include "ov13855pd1901v1mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13855PD1901V1_SENSOR_ID,
...
extern int ov13855pd1901v1_vivo_otp_read(void);
static int vivo_otp_read_when_power_on = 0;
extern otp_error_code_t OV13855PD1901V1_OTP_ERROR_CODE;
extern unsigned int is_atboot;
extern unsigned  int ov13855pd1901v1_flag;
MUINT32 sn_inf_main_ov13855pd1901v1pd[13];  /*0 flag   1-12 data*/
...
static void write_shutter(kal_uint32 shutter)
{
	...
	if(shutter > 32759) {
        ...
        pr_info("Calc long exposure exposure_time:%d long_shutter %d -\n",exposure_time,long_shutter);
		long_shutter = (long_shutter >> 1) << 1;
		pr_info("Calc long exposure  -\n");

		write_cmos_sensor_8(0x3208, 0x00);  /* group hold */
		write_cmos_sensor_8(0x3824, 0x00);
		write_cmos_sensor_8(0x3825, 0x00);
		write_cmos_sensor_8(0x3826, 0x00);
		write_cmos_sensor_8(0x3827, 0x00);
		...
		write_cmos_sensor_8(0x3501, 0xc8);
		...
		write_cmos_sensor_8(0x3209, 0x41); /*stay 1 frame; auto exit long exp*/
...
static void sensor_init(void)
{
	...
	write_cmos_sensor_8(0x0100, 0x00);
	write_cmos_sensor_8(0x3021, 0x23);
...
static void preview_setting(void)
{
	...
	write_cmos_sensor_8(0x0302, 0x5e);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
				*sensor_id = return_sensor_id();
				...
				vivo_otp_read_when_power_on = ov13855pd1901v1_vivo_otp_read();
				pr_debug("add:end read eeprom - when_power_on = %d\n",vivo_otp_read_when_power_on);
			    /*vivo hope add end*/
				 //if(ov13855pd1901v1_flag == 1){
					pr_debug("i2c write id: 0x%x, sensor id: 0x%x, ov13855pd1901v1_flag = %d\n", imgsensor.i2c_write_id,*sensor_id, ov13855pd1901v1_flag);
					return ERROR_NONE;
				//}
			}
				pr_debug("Read sensor id fail, id: 0x%x or ov13855pd1901v1_flag = %d\n",
						imgsensor.i2c_write_id, ov13855pd1901v1_flag);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
	}
	if (*sensor_id != imgsensor_info.sensor_id || ov13855pd1901v1_flag != 1) {
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
            switch (*feature_data) {
                case 0:    //info type: otp state
                    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV13855PD1901V1_OTP_ERROR_CODE;//otp_state
					memcpy(feature_data+2, sn_inf_main_ov13855pd1901v1pd, sizeof(MUINT32)*13);
					break;
            }
            break;
