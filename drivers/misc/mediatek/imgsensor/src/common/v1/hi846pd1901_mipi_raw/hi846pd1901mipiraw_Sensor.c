 ...
 * Filename:
 * ---------
 *	 HI846PD1901PD1901_mipi_raw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "hi846pd1901_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI846PD1901_SENSOR_ID,
	...
	.normal_video = {
		.pclk = 288000000,				//record different mode's pclk
		.linelength = 3800,				//record different mode's linelength
		.framelength = 2498,			/*record different mode's framelength*/
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
...
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_HI846PD1901;
MUINT32  sn_inf_main2_hi846pd1901[13];  /*0 flag   1-12 data*/
			...
			do {
				*sensor_id = return_sensor_id() + 2;
				if (*sensor_id == imgsensor_info.sensor_id) {				
					...
					LOG_INF("cfx_add:end read eeprom ---vivo_main3_otp_read_when_power_on = %d,MAIN3_OTP_ERROR_CODE_HI846PD1901 =%d\n", vivo_main3_otp_read_when_power_on,MAIN3_OTP_ERROR_CODE_HI846PD1901);
					/*vivo caofeixiang add end*/
					return ERROR_NONE;
				}	
...
//    unsigned long long *feature_return_para=(unsigned long long *) feature_para;
	...
	break;
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
		    LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_OTP_ERROR_CODE_HI846PD1901:%d \n", *feature_data,MAIN3_OTP_ERROR_CODE_HI846PD1901);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_HI846PD1901;//otp_state
					memcpy( feature_data+2, sn_inf_main2_hi846pd1901, sizeof(MUINT32)*13); 
					#if 0
							for (i = 0 ; i<12 ; i++ ){
							printk("sn_inf_main2_hi846pd1901[%d]= 0x%x\n", i, sn_inf_main2_hi846pd1901[i]);
							}
...
UINT32 HI846PD1901_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	HI846PD1901_MIPI_RAW_SensorInit	*/
