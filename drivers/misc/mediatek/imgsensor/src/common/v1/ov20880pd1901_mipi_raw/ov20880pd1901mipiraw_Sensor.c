...
#define PFX "ov20880pd1901mipiraw_Sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV20880PD1901MIPI_SENSOR_ID,
...
extern int ov20880pd1901_vivo_otp_read(void);
static int vivo_otp_read_when_power_on = 0;
extern otp_error_code_t OV20880PD1901_OTP_ERROR_CODE;
extern unsigned int is_atboot;

MUINT32 sn_inf_main_ov20880pd1901pd[13];  /*0 flag   1-12 data*/
MUINT32 dpc_data[837];  /*0 flag   1-606 data*/
MUINT32 crosstalk_data[607];  /*0 flag   1-836 data*/
extern MUINT8  ctidFlag;
extern int ov20880_read_sn_id_v1(void);
...
kal_uint16 addr_data_pair_init_ov20880pd1901[] = {
0x0103, 0x01,
0x0100, 0x00,
0x0300, 0x06,
0x0301, 0xe1,
...
kal_uint16 addr_data_pair_preview_ov20880pd1901[] = {
0x0303, 0x11,
0x0304, 0x44,
0x0305, 0x03,
0x0317, 0x04,
...
kal_uint16 addr_data_pair_capture_ov20880pd1901[] = {
0x0303, 0x01,
0x0304, 0xe0,
0x0305, 0x01,
0x0317, 0x02,
...
kal_uint16 addr_data_pair_normal_video_ov20880pd1901[] = {
0x0303, 0x11,
0x0304, 0x44,
0x0305, 0x03,
0x0317, 0x04,
...
kal_uint16 addr_data_pair_hs_video_ov20880pd1901[] = {
0x0303, 0x11,
0x0304, 0x44,
0x0305, 0x03,
0x0317, 0x04,
...
kal_uint16 addr_data_pair_slim_video_ov20880pd1901[] = {
0x0303, 0x11,
0x0304, 0x44,
0x0305, 0x03,
0x0317, 0x04,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_ov20880pd1901,
                          sizeof(addr_data_pair_init_ov20880pd1901) / sizeof(kal_uint16));
}				/*      sensor_init  */
static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_ov20880pd1901,
                          sizeof(addr_data_pair_preview_ov20880pd1901) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_ov20880pd1901,
                          sizeof(addr_data_pair_capture_ov20880pd1901) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_ov20880pd1901,
                          sizeof(addr_data_pair_normal_video_ov20880pd1901) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_ov20880pd1901,
                          sizeof(addr_data_pair_hs_video_ov20880pd1901) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_ov20880pd1901,
                          sizeof(addr_data_pair_slim_video_ov20880pd1901) / sizeof(kal_uint16));
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
          ...
          if(0 == ctidFlag){
             	 if(0x35463136 == ov20880_read_sn_id_v1())
			 {
			...
			//	pr_debug("add:start read eeprom  - when_power_on  = %d\n",vivo_otp_read_when_power_on);
				vivo_otp_read_when_power_on = ov20880pd1901_vivo_otp_read();
...
static kal_uint32 open(void)
{
	...
	pr_debug("PLATFORM:MIPI 4LANE ov20880pd1901+++++ ++++\n");
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
            switch (*feature_data) {
                case 0:    //info type: otp state
                    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV20880PD1901_OTP_ERROR_CODE;//otp_state
					memcpy(feature_data+2, sn_inf_main_ov20880pd1901pd, sizeof(MUINT32)*13);
					break;
            }
            break;
