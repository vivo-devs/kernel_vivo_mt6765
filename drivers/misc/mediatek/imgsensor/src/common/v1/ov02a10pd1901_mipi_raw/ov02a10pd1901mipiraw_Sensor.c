...
#include "ov02a10pd1901mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV02A10PD1901_SENSOR_ID,
...
static void set_dummy(void)
{
	...
	write_cmos_sensor_8_8(0x4e, imgsensor.frame_length >> 8);
	write_cmos_sensor_8_8(0x4f, imgsensor.frame_length & 0xFF);
	write_cmos_sensor_8_8(0x05, (imgsensor.frame_length-1224) >> 8);
	write_cmos_sensor_8_8(0x06, (imgsensor.frame_length-1224) & 0xFF);
	write_cmos_sensor_8_8(0x8c, imgsensor.line_length >> 8);
	write_cmos_sensor_8_8(0x8d, imgsensor.line_length & 0xFF);
				...
				kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	write_cmos_sensor_8_8(0x03, (shutter >> 8) & 0xFF);
	write_cmos_sensor_8_8(0x01, 0x01);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	write_cmos_sensor_8_8(0xfd, 0x01);
	write_cmos_sensor_8_8(0x24, (reg_gain&0xFF));
	write_cmos_sensor_8_8(0x01, 0x01);
	return gain;
}	/*	set_gain  */
			...
			kal_uint16 le, kal_uint16 se, kal_uint16 gain)
{
	...
	if (imgsensor.ihdr_en) {
		...
		write_cmos_sensor_8_8(0x380e, imgsensor.frame_length >> 8);
		write_cmos_sensor_8_8(0x380f, imgsensor.frame_length & 0xFF);
		write_cmos_sensor_8_8(0x3502, (le << 4) & 0xFF);
		write_cmos_sensor_8_8(0x3501, (le >> 4) & 0xFF);
		write_cmos_sensor_8_8(0x3500, (le >> 12) & 0x0F);
		write_cmos_sensor_8_8(0x3512, (se << 4) & 0xFF);
		write_cmos_sensor_8_8(0x3511, (se >> 4) & 0xFF);
		write_cmos_sensor_8_8(0x3510, (se >> 12) & 0x0F);
		set_gain(gain);
	}
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			*sensor_id = ( (read_cmos_sensor_8_8(0x02) << 8) | read_cmos_sensor_8_8(0x03));
			     ...
			     MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (imgsensor.test_pattern == KAL_TRUE) {
		/*write_cmos_sensor_8_8(0x5002,0x00);*/
		write_cmos_sensor_8_8(0x5000, (read_cmos_sensor_8_8(0x5000)&0xBF)|0x00);
	}
	set_mirror_flip(imgsensor.mirror);
	return ERROR_NONE;
}	/* capture() */
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
	//	write_cmos_sensor_8_8(0x5000, 0x57);
//		write_cmos_sensor_8_8(0x5001, 0x02);
//		write_cmos_sensor_8_8(0x5e00, 0x80);
	} else {
//		write_cmos_sensor_8_8(0x5000, 0x77);
//		write_cmos_sensor_8_8(0x5001, 0x0a);
//		write_cmos_sensor_8_8(0x5e00, 0x00);
	}
	spin_lock(&imgsensor_drv_lock);
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable){
		write_cmos_sensor_8_8(0xfd, 0X01);
		write_cmos_sensor_8_8(0xac, 0X01);
	}
	else{
		write_cmos_sensor_8_8(0xfd, 0X01);
		write_cmos_sensor_8_8(0xac, 0X00);
		mdelay(50);
	}
	return ERROR_NONE;
}
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
            ...
            switch (*feature_data) {
                case 0:    //info type: otp state
                    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OTP_ERROR_CODE_NORMAL;//otp_state
                    break;
            }
            break;
