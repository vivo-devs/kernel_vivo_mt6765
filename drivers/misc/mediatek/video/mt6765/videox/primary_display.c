...
unsigned int report_lcm_id(void)
{
	...
	if	(lcm_id_version == 0x7C)
		...
		return 0xFF;
	} else if (!strcmp(project_name, "PD2140IF_EX"))  {
	if	(lcm_id_version == 0x7C)
		return 0x31;
	else if (lcm_id_version == 0x45)
		return 0x13;
...
int primary_display_resume(void)
{
	...
	if (lcm_drv->lcm_reset) {
		...
		if (!strcmp(project_name, "PD1987") || !strcmp(project_name, "PD2014")) {
			lcm_drv->lcm_reset();
		} else if ((!strcmp(project_name, "PD2036F_EX")) || (!strcmp(project_name, "PD2139F_EX")) || (!strcmp(project_name, "PD2140F_EX")) || (!strcmp(project_name, "PD2140")) || (!strcmp(project_name, "PD2140IF_EX"))) {
