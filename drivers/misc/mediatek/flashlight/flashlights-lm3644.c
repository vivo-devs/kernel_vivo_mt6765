...
#elif defined(CONFIG_MTK_CAM_PD2140F_EX) ||defined(CONFIG_MTK_CAM_PD2140IF_EX)|| defined(CONFIG_MTK_CAM_PD2140)
...
static int lm3644_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if(device_id  != 0x02){
		...
		device_id = lm3644_read_reg(lm3644_i2c_client, LM3644_DEVICE_ID);
		pr_info("lm3644_i2c_probe lm36413 DEVICE_ID = 0x%x\n", device_id);
	}
#endif
