...
static struct LCM_setting_table init_setting_12bit[] = {
	...
	{0x41, 2, {0x5A, 0x0A}},
	{0x80, 16, {0xA5, 0x3E, 0xA5, 0xAA, 0xA5, 0x88, 0x42, 0x68, 0xA6, 0x03, 0x07, 0x01, 0x64, 0x3F, 0x50, 0x32}},
	...
	{0x41, 2, {0x5A, 0x0B}},
	{0x80, 16, {0xFF, 0xAA, 0xD2, 0x00, 0x00, 0x0B, 0x21, 0x34, 0x3F, 0x4B, 0x5C, 0x6A, 0x6B, 0x77, 0x77, 0x8A}},
	{0x90, 16, {0x7B, 0x6A, 0x6C, 0x62, 0x5A, 0x4E, 0x3F, 0x35, 0x2C, 0x1B, 0x06, 0x01, 0x00, 0x0B, 0x21, 0x34}},
	{0xA0, 16, {0x3F, 0x4B, 0x5C, 0x6A, 0x6B, 0x77, 0x77, 0x8A, 0x7B, 0x6A, 0x6C, 0x62, 0x5A, 0x4E, 0x3F, 0x35}},
	{0xB0, 5, {0x2C, 0x1B, 0x06, 0x01, 0x00}},
	{0x41, 2, {0x5A, 0x0C}},
	{0x80, 16, {0x00, 0x00, 0x20, 0x42, 0x00, 0x00, 0x80, 0x05, 0x54, 0x00, 0x00, 0x00, 0x20, 0x42, 0x00, 0x00}},
	{0x90, 2, {0x80, 0x05}},
	{0x41, 2, {0x5A, 0x0D}},
	{0x80, 16, {0x7A, 0xD0, 0x02, 0x08, 0x06, 0xFA, 0x00, 0xFA, 0x00, 0x0A, 0x0A, 0x0A, 0x0A, 0x00, 0x01, 0x03}},
	...
	{0x41, 2, {0x5A, 0x14}},
	{0x80, 16, {0x01, 0x02, 0x40, 0x5E, 0xD1, 0xDF, 0xEF, 0xF7, 0xFB, 0xFD, 0x02, 0x00, 0x00, 0x04, 0x8B, 0x8B}},
	{0x90, 16, {0x11, 0x7C, 0x40, 0x3C, 0x8C, 0xE0, 0x03, 0x62, 0x65, 0x04, 0x1F, 0x10, 0x2B, 0x23, 0xF8, 0x00}},
	{0xA0, 16, {0x00, 0xF8, 0xFD, 0x00, 0x00, 0xC0, 0xEF, 0x07, 0x00, 0x2F, 0x16, 0x6B, 0xC5, 0xEF, 0x8F, 0x40}},
	{0xB0, 16, {0xB0, 0x13, 0xBF, 0x3F, 0x02, 0x00, 0x00, 0x00, 0x00, 0xB8, 0x60, 0x0B, 0x56, 0x00, 0x80, 0x42}},
	{0xC0, 16, {0xA1, 0xF0, 0x16, 0xEE, 0x6E, 0x02, 0x00, 0x00, 0xDE, 0xC1, 0xDD, 0x4D, 0x00, 0x00, 0xC0, 0x1B}},
	{0xD0, 16, {0xB8, 0xBB, 0x09, 0x00, 0x00, 0x78, 0x01, 0x77, 0x37, 0x01, 0x00, 0x00, 0xAF, 0xE0, 0xEE, 0x26}},
	{0xE0, 16, {0x00, 0x00, 0xE0, 0x25, 0xDC, 0xDD, 0x04, 0x00, 0x00, 0xBC, 0x86, 0xBB, 0x9B, 0x00, 0x00, 0x80}},
	{0xF0, 16, {0x17, 0x71, 0x77, 0x13, 0x00, 0x00, 0x30, 0x06, 0x7E, 0x3F, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00}},
	{0x41, 2, {0x5A, 0x15}},
	{0x80, 16, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x80, 0xFF, 0xEF}},
	{0x90, 16, {0x27, 0x03, 0x0B, 0xD6, 0x88, 0x51, 0xAB, 0x0D, 0xA1, 0xD5, 0x3E, 0x62, 0xD4, 0x6A, 0x43, 0x68}},
	...
	{0x90, 10, {0x00, 0x00, 0x00, 0x00, 0x80, 0x42, 0x2A, 0x01, 0x00, 0x00}},
	{0x41, 2, {0x5A, 0x18}},
	...
	{0x41, 2, {0x5A, 0x19}},
	{0x80, 16, {0xC8, 0xB8, 0xA9, 0x9E, 0x95, 0x8D, 0x87, 0x82, 0x80, 0x80, 0x80, 0x80, 0x77, 0xF7, 0xFF, 0xFF}},
	{0x90, 16, {0xFF, 0x0F, 0xF0, 0xBF, 0x7F, 0x4F, 0x0F, 0xFF, 0xAF, 0xB5, 0x71, 0x0E, 0x6C, 0x4A, 0x69, 0x08}},
	{0xA0, 4, {0x00, 0x00, 0x46, 0x00}}, /*46 is 11bit backlight 48 is 12bit */
	{0x41, 2, {0x5A, 0x1A}},
	{0x80, 16, {0xFF, 0x00, 0x04, 0x08, 0x0C, 0x50, 0x10, 0x14, 0x18, 0x1C, 0xA5, 0x20, 0x28, 0x30, 0x39, 0x3E}},
	{0x90, 16, {0x41, 0x49, 0x51, 0x59, 0x94, 0x61, 0x69, 0x71, 0x79, 0xFA, 0x81, 0x8A, 0x92, 0x9A, 0x03, 0xA2}},
	{0xA0, 16, {0xAA, 0xB2, 0xBA, 0x00, 0xC2, 0xCA, 0xD1, 0xD9, 0xF0, 0xE1, 0xE9, 0xF0, 0xF8, 0x06, 0xFC, 0xFE}},
	{0xB0, 16, {0xFF, 0x00, 0x00, 0x04, 0x08, 0x0C, 0x00, 0x10, 0x14, 0x18, 0x1C, 0x00, 0x20, 0x28, 0x30, 0x37}},
	{0xC0, 16, {0xC0, 0x3F, 0x47, 0x4F, 0x57, 0xFF, 0x5F, 0x67, 0x6F, 0x77, 0xFF, 0x7F, 0x87, 0x8F, 0x97, 0xFF}},
	{0xD0, 16, {0x9F, 0xA7, 0xAF, 0xB7, 0xFF, 0xBF, 0xC7, 0xCF, 0xD7, 0xFF, 0xE0, 0xE8, 0xF0, 0xF8, 0x00, 0xFC}},
	{0xE0, 16, {0xFE, 0xFF, 0x00, 0x00, 0x03, 0x07, 0x0B, 0x6C, 0x0F, 0x12, 0x16, 0x1A, 0x6C, 0x1E, 0x26, 0x2E}},
	{0xF0, 16, {0x35, 0xC0, 0x3D, 0x45, 0x4D, 0x55, 0x1A, 0x5C, 0x64, 0x6C, 0x73, 0xC7, 0x7B, 0x83, 0x8B, 0x92}},
	{0x41, 2, {0x5A, 0x1B}},
	{0x80, 16, {0x86, 0x9A, 0xA2, 0xA9, 0xB1, 0xB1, 0xB9, 0xC1, 0xC8, 0xD0, 0xF1, 0xD8, 0xE0, 0xE9, 0xF1, 0xAF}},
	{0x90, 5, {0xF5, 0xF7, 0xF8, 0x15, 0x00}},
	{0x41, 2, {0x5A, 0x1C}},
	...
	{0xB0, 16, {0x12, 0x0C, 0x20, 0x00, 0x80, 0x04, 0x18, 0x01, 0x48, 0x00, 0x22, 0x18, 0x10, 0x0A, 0x06, 0xC9}},
	...
	{0x41, 2, {0x5A, 0x26}},
	{0x80, 16, {0x00, 0x83, 0x00, 0xFF, 0xFF, 0x60, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5c, 0x58}},
...
static struct LCM_setting_table init_setting_12bit_IS[] = {
	{0x41, 1, {0x5A} },
	{0x41, 2, {0x5A, 0x03} },
	{0x80, 2, {0xA9, 0x00} },
	{0x41, 2, {0x5A, 0x09} },
	...
	{0x41, 2, {0x5A, 0x0B} },
	{0x80, 16, {0xE0, 0xAC, 0xD0, 0x00, 0x00, 0x0B, 0x21, 0x34, 0x3F, 0x4B, 0x5C, 0x6A, 0x6B, 0x77, 0x77, 0x8A} },
	{0x90, 16, {0x7B, 0x6A, 0x6C, 0x62, 0x5A, 0x4E, 0x3F, 0x35, 0x2C, 0x1B, 0x06, 0x01, 0x00, 0x0B, 0x21, 0x34} },
	{0xA0, 16, {0x3F, 0x4B, 0x5C, 0x6A, 0x6B, 0x77, 0x77, 0x8A, 0x7B, 0x6A, 0x6C, 0x62, 0x5A, 0x4E, 0x3F, 0x35} },
	{0xB0, 5, {0x2C, 0x1B, 0x06, 0x01, 0x00} },
	{0x41, 2, {0x5A, 0x0C} },
	...
	//3 Gamma
	{0x41, 2, {0x5A, 0x1A} },
	{0x80, 16, {0xE0, 0x00, 0x04, 0x08, 0x0C, 0x50, 0x10, 0x14, 0x18, 0x1C, 0xA5, 0x20, 0x28, 0x30, 0x39, 0x3E} },
	{0x90, 16, {0x41, 0x49, 0x51, 0x59, 0x94, 0x61, 0x69, 0x71, 0x79, 0xFA, 0x81, 0x8A, 0x92, 0x9A, 0x03, 0xA2} },
	{0xA0, 16, {0xAA, 0xB2, 0xBA, 0x00, 0xC2, 0xCA, 0xD1, 0xD9, 0xF0, 0xE1, 0xE9, 0xF0, 0xF8, 0x06, 0xFC, 0xFE} },
	{0xB0, 16, {0xFF, 0x00, 0x00, 0x04, 0x08, 0x0C, 0x00, 0x10, 0x14, 0x18, 0x1C, 0x00, 0x20, 0x28, 0x30, 0x37} },
	{0xC0, 16, {0xC0, 0x3F, 0x47, 0x4F, 0x57, 0xFF, 0x5F, 0x67, 0x6F, 0x77, 0xFF, 0x7F, 0x87, 0x8F, 0x97, 0xFF} },
	...
	{0x90, 11, {0x00, 0x00, 0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0xDF, 0x07, 0x35} },
	{0x41, 2, {0x5A, 0x26} },
	{0x80, 16, {0x00, 0x83, 0x00, 0xFB, 0xBF, 0x60, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xD6, 0x4B} },
	{0x90, 3, {0x5A, 0xA5, 0x5A} },
	{0x90, 1, {0xA5} },
	{0x41, 2, {0x00, 0x2F} },
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_frontporch = 41;//45
...
{
	LCM_INFO("%s ft8006p -> enter power on begin, panel_reset_state=%d\n", __func__, panel_reset_state);
	...
	************************************/
		...
		LCM_INFO("%s ft8006p -> enter power on end\n", __func__);
	}
}
...
static void lcm_init(void)
{
	...
	panel_off_state = 0;
	pr_err("[LCM]ft8006p- init middle, add to trace bug, resume cose 4s\n");
	if (lcm_id_version == 0x60)
	push_table(init_setting_12bit, sizeof(init_setting_12bit) / sizeof(struct LCM_setting_table), 1);
	else
	push_table(init_setting_12bit_IS, sizeof(init_setting_12bit_IS) / sizeof(struct LCM_setting_table), 1);
	pr_err("[LCM]ft8006p- init end\n");
}
...
static void lcm_suspend(void)
{
	push_table(lcm_suspend_setting,
		...
		1);
	panel_off_state = 1;
	pr_err("[LCM]ft8006p- lcm_suspend display off\n");
}
...
{
	if (lcm_id_version == 0x60 || lcm_id_version == 0x7E)
		return 0x15;
	else
		return 0x15;
}
...
struct LCM_DRIVER pd1901_tianma_ft8006p_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd1901_tianma_ft8006p_noflash_hdp_dsi_vdo",
