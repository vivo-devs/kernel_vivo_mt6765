...
static struct LCM_setting_table init_setting_12bit[] = {
	...
	{0xE0,27,{0x00,0x09,0x3E,0x68,0xA2,0x50,0xD1,0xF6,0x24,0x49,0x95,0x86,0xB7,0xE3,0x0D,0xAA,0x38,0x6D,0x8E,0xBA,0xFE,0xDF,0x11,0x51,0x85,0x03,0xA5}},
	{0xE1,27,{0x00,0x09,0x3E,0x68,0xA2,0x50,0xD1,0xF6,0x24,0x49,0x95,0x86,0xB7,0xE3,0x0D,0xAA,0x38,0x6D,0x8E,0xBA,0xFE,0xDF,0x11,0x51,0x85,0x03,0xEE}},
	{0xFF,3,{0x98,0x82,0x0A}},
	{0x80,1,{0x01}},
	{0x00,58,{0x00,0x01,0x03,0x08,0x0C,0x10,0x14,0x18,0x1C,0x20,0x24,0x28,0x2C,0x30,0x34,0x38,0x3C,0x41,0x45,0x48,0x4C,0x50,0x54,0x58,0x60,0x68,0x70,0x80,0x90,0x98,0xA0,0xA8,0xB0,0xB7,0xBF,0xC8,0xD0,0xD7,0xDF,0xE7,0xEF,0xF7,0xF9,0xFB,0xFC,0xFD,0x3C,0x55,0xA5,0xA9,0xC3,0xE6,0xAB,0x48,0x2E,0xBC,0x01,0x0F}},
	{0xFE,58,{0x00,0x01,0x04,0x07,0x0C,0x10,0x14,0x18,0x1C,0x1F,0x24,0x28,0x2B,0x30,0x34,0x37,0x3C,0x40,0x44,0x48,0x4B,0x4F,0x53,0x57,0x5F,0x67,0x6F,0x7F,0x8E,0x97,0x9F,0xA7,0xAF,0xB6,0xBE,0xC7,0xCF,0xD7,0xDF,0xE7,0xEF,0xF7,0xF9,0xFB,0xFD,0xFF,0xCC,0x10,0x1C,0xC3,0x15,0xE7,0x5A,0x03,0x7E,0xA5,0xFF,0x03}},
	{0xFE,58,{0x00,0x01,0x03,0x08,0x0D,0x10,0x14,0x17,0x1B,0x1F,0x24,0x28,0x2C,0x30,0x34,0x38,0x3D,0x41,0x45,0x49,0x4D,0x50,0x55,0x59,0x61,0x69,0x71,0x81,0x90,0x99,0xA0,0xA8,0xB0,0xB7,0xBF,0xC7,0xCF,0xD7,0xDF,0xE6,0xEE,0xF6,0xF8,0xFA,0xFC,0xFD,0x94,0x6C,0x06,0xA8,0x14,0x5C,0x15,0xA3,0xEF,0xC6,0xEA,0x0E}},
	{0xFF,3,{0x98,0x82,0x00}},
	{0x29,0,{}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.PLL_CLOCK_dyn = 430;
	params->dsi.horizontal_backporch_dyn = 86;
}


static void lcm_init_power(void)
{
	LCM_INFO("%s inx ili9882n -> enter power on begin, panel_reset_state=%d\n", __func__, panel_reset_state);
...
static void lcm_init(void)
{
	...
	******************************************************************/
	...
	LCM_INFO("[LCM]inx ili9882n- init end\n");
}
...
static void lcm_suspend(void)
{
	push_table(lcm_suspend_setting,
		...
		1);
	panel_off_state = 1;
	LCM_INFO("[LCM]inx ili9882n- lcm_suspend display off\n");
}
...
struct LCM_DRIVER pd2074_inx_ili9882n_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd2074_inx_ili9882n_noflash_hdp_dsi_vdo",
