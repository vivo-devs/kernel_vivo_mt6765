...
static struct LCM_setting_table init_setting_12bit[] = {
	...
	{0x41,2,{0x5A,0x19}},
	{0x80,16,{0xCD,0xC6,0xB9,0xAF,0xA6,0x9F,0x98,0x93,0x8E,0x89,0x86,0x82,0x77,0x67,0xF6,0xCF}},
	{0x90,16,{0xFC,0xCF,0xFC,0xEF,0xCF,0xCF,0x0F,0xFF,0xAF,0xB5,0x71,0x0E,0x6C,0x4A,0x69,0x08}},
	...
	{0x41,2,{0x5A,0x24}},
	{0x80,16,{0x00,0x03,0x00,0xFF,0xFF,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x7B,0x93}},
...
/*#ifdef CONFIG_MTK_LCM_MIPI_CLK_CONTROL*/
	if (rf_hw_id == 1) {
		...
		LCM_INFO("%s PD2074 rf_hw_id PLL_CLOCK %d\n", __func__, params->dsi.PLL_CLOCK);
	}
/*#endif*/
...
struct LCM_DRIVER pd2074_txd_ft8016_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd2074_txd_ft8016_noflash_hdp_dsi_vdo",
