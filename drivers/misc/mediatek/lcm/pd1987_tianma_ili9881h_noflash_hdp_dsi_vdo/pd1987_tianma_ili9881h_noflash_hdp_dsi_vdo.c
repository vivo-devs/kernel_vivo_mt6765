...
{
	LCM_INFO("[LCM]pd1987_tianma_ili9881h");

	if (phone_shutdown_state) {
		LCM_INFO("[LCM]pd1987_tianma_ili9881h lcm_suspend_power reset keep low level\n");
		lcm_reset_setting(0);
	}
	MDELAY(10);
	lcm_enn_setting(0);
...
struct LCM_DRIVER pd1987_tianma_ili9881h_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd1987_tianma_ili9881h_noflash_hdp_dsi_vdo",
