...
static struct LCM_setting_table init_setting_12bit[] = {
	...
	{0x41,2,{0x5A,0x0A}},
	{0x80,16,{0xA5,0x15,0xA5,0xAA,0xA5,0x88,0x42,0xC8,0x8C,0x03,0x07,0x05,0x4D,0x61,0x46,0x5A}},
	...
	{0x41,2,{0x5A,0x0B}},
	{0x80,16,{0xE0,0xBE,0xE6,0x00,0x00,0x05,0x12,0x1D,0x27,0x30,0x40,0x4E,0x50,0x5E,0x63,0x7B}},
	{0x90,16,{0x85,0x6F,0x6E,0x62,0x59,0x4C,0x3C,0x33,0x29,0x19,0x06,0x01,0x00,0x05,0x12,0x1D}},
	{0xA0,16,{0x27,0x30,0x40,0x4E,0x50,0x5E,0x63,0x7B,0x85,0x6F,0x6E,0x62,0x59,0x4C,0x3C,0x33}},
	{0xB0,5,{0x29,0x19,0x06,0x01,0x00}},
	{0x41,2,{0x5A,0x0C}},
	{0x80,16,{0x00,0x00,0x20,0x42,0x00,0x00,0x80,0x05,0x54,0x00,0x00,0x00,0x20,0x42,0x00,0x00}},
	{0x90,2,{0x80,0x05}},
	{0x41,2,{0x5A,0x0D}},
	{0x80,16,{0x7A,0xD0,0x02,0x08,0x06,0xED,0x00,0xF3,0x00,0x0A,0x0A,0x0A,0x0A,0x00,0x01,0x03}},
	...
	{0x41,2,{0x5A,0x11}},
	{0x80,16,{0x00,0x00,0x03,0xE7,0x1F,0x17,0x28,0x48,0x68,0x12,0x90,0x1A,0x30,0x88,0x41,0x8A}},
	...
	{0x41,2,{0x5A,0x14}},
	{0x80,16,{0x01,0x02,0x40,0x5E,0xD1,0xDF,0xEF,0xF7,0xFB,0xFD,0x02,0x00,0x00,0x04,0x8B,0x0F}},
	...
	{0xB0,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xD8,0x60,0x0D,0x56,0x00,0x80,0x42}},
	...
	{0x90,16,{0xE7,0x01,0x0A,0xF6,0x88,0x51,0xAB,0x08,0x22,0x23,0x2B,0x62,0xD4,0x6A,0x83,0xC8}},
	{0xA0,16,{0xC8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x05}},
	...
	{0x90,10,{0x00,0x00,0x00,0x00,0x80,0x42,0x29,0x01,0x00,0x00}},
	{0x41,2,{0x5A,0x18}},
	...
	{0x41,2,{0x5A,0x1A}},
	{0x80,16,{0xFF,0x00,0x04,0x08,0x0C,0x00,0x10,0x14,0x17,0x1B,0xF0,0x1F,0x27,0x2F,0x37,0xAB}},
	{0x90,16,{0x3F,0x47,0x4F,0x57,0xAE,0x5F,0x67,0x6F,0x77,0x52,0x7F,0x87,0x8F,0x97,0x25,0x9F}},
	{0xA0,16,{0xA7,0xAF,0xB7,0xAA,0xBF,0xC7,0xCF,0xD7,0xF6,0xDF,0xE7,0xF0,0xF8,0x0F,0xFC,0xFE}},
	{0xB0,16,{0xFF,0x00,0x00,0x04,0x08,0x0C,0x00,0x0F,0x13,0x17,0x1B,0xAF,0x1F,0x27,0x2F,0x37}},
	{0xC0,16,{0x16,0x3F,0x47,0x4F,0x57,0x08,0x5F,0x66,0x6E,0x76,0xA8,0x7E,0x86,0x8E,0x96,0x2A}},
	{0xD0,16,{0x9E,0xA6,0xAE,0xB5,0xC0,0xBD,0xC5,0xCD,0xD5,0x63,0xDD,0xE5,0xEC,0xF4,0xF0,0xF8}},
	{0xE0,16,{0xFA,0xFB,0x2A,0x00,0x03,0x07,0x0B,0x2C,0x0E,0x12,0x16,0x1A,0x1B,0x1D,0x25,0x2D}},
	{0xF0,16,{0x35,0x1B,0x3C,0x44,0x4C,0x53,0xCB,0x5B,0x63,0x6A,0x72,0x72,0x7A,0x81,0x89,0x91}},
	{0x41,2,{0x5A,0x1B}},
	{0x80,16,{0x18,0x98,0xA0,0xA8,0xAF,0xCB,0xB7,0xBF,0xC7,0xCF,0x16,0xD6,0xDE,0xE7,0xEE,0x8F}},
	{0x90,5,{0xF2,0xF4,0xF5,0x16,0x00}},
	{0x41,2,{0x5A,0x1C}},
	...
	{0xD0,16,{0x99,0x19,0x11,0x11,0x11,0x11,0x11,0x11,0x08,0xC0,0xE3,0x81,0x00,0x20,0x80,0x27}},
	...
	{0x41,2,{0x5A,0x26}},
	{0x80,16,{0x00,0x83,0x00,0xFB,0xBF,0x60,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0xF8,0xA9}},
...
//Blank 11
        {0x41,2, {0x5A,0x0B}},
        {0x80,16, {0xFF,0xBE,0xE6,0x00,0x00,0x05,0x11,0x1C,0x27,0x32,0x40,0x4E,0x50,0x5D,0x61,0x79} },
        {0x90,16, {0x87,0x71,0x6F,0x63,0x5A,0x4E,0x3E,0x34,0x2A,0x1A,0x07,0x01,0x00,0x05,0x11,0x1C} },
        {0xA0,16, {0x27,0x32,0x40,0x4E,0x50,0x5D,0x61,0x79,0x87,0x71,0x6F,0x63,0x5A,0x4E,0x3E,0x34} },
        {0xB0,5, {0x2A,0x1A,0x07,0x01,0x00}},
//Blank 12
        {0x41,2, {0x5A,0x0C} },
        {0x80,16, {0x00,0x00,0x20,0x42,0x00,0x00,0x80,0x05,0x54,0x00,0x00,0x00,0x20,0x42,0x00,0x00} },
        {0x90,2, {0x80,0x05} },
...
//Blank 20
        ...
        {0xD0,16, {0x10,0xBD,0x07,0x94,0xE2,0x78,0x05,0xA2,0xF7,0x80,0x52,0x1C,0xEF,0x42,0xF4,0x1E} },
        {0xE0,16, {0x50,0x8A,0xE3,0x4D,0x88,0xDE,0x03,0x4A,0x71,0xBC,0x07,0xD1,0x7B,0x40,0x29,0x8E} },
        {0xF0,16, {0xB7,0x20,0x7A,0x0F,0x28,0xC5,0x31,0x06,0x7E,0x3F,0x14,0x00,0x00,0x00,0x00,0x00} },
//Blank 21
        {0x41,2, {0x5A,0x15} },
        {0x80,16, {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0C,0x80,0xC1,0xEF} },
        {0x90,16, {0xE7,0x01,0x0A,0xF6,0x88,0x51,0xAB,0x08,0x22,0x23,0x2B,0x62,0xD4,0x6A,0x83,0xC8} },
        {0xA0,16, {0xC8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x05} },
        {0xB0,16, {0x33,0x62,0xD4,0x2A,0x00,0x00,0x00,0x00,0x26,0x00,0xE0,0x01,0x28,0xAD,0x09,0x9A} },
        {0xC0,16, {0x92,0x95,0xA6,0x82,0xA1,0x38,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xA6,0xA0} },
...
//Blank 26
        {0x41,2, {0x5A,0x1A} },
        {0x80,16, {0xFF,0x00,0x03,0x07,0x0B,0xBC,0x0F,0x13,0x17,0x1A,0xC6,0x1E,0x26,0x2E,0x35,0xCA} },
        {0x90,16, {0x3D,0x45,0x4C,0x54,0xB7,0x5C,0x64,0x6B,0x73,0xB2,0x7B,0x83,0x8B,0x93,0x05,0x9A} },
        {0xA0,16, {0xA2,0xAA,0xB2,0x06,0xBA,0xC2,0xC9,0xD1,0xF0,0xD9,0xE1,0xE9,0xF1,0x7B,0xF5,0xF7} },
        {0xB0,16, {0xF8,0x16,0x00,0x04,0x08,0x0C,0x00,0x10,0x14,0x17,0x1B,0xF0,0x1F,0x27,0x2F,0x37} },
        {0xC0,16, {0xFE,0x3F,0x47,0x4F,0x57,0xFE,0x5F,0x67,0x6F,0x77,0xBB,0x7F,0x87,0x8F,0x97,0xAA} },
        {0xD0,16, {0x9F,0xA7,0xAF,0xB7,0x05,0xBF,0xC6,0xCE,0xD6,0xBC,0xDE,0xE6,0xEE,0xF6,0x36,0xFA} },
        {0xE0,16, {0xFC,0xFD,0x00,0x00,0x04,0x07,0x0B,0xF0,0x0F,0x13,0x17,0x1B,0x5A,0x1F,0x27,0x2F} },
        {0xF0,16, {0x37,0x54,0x3F,0x47,0x4F,0x57,0x05,0x5F,0x66,0x6E,0x76,0xBC,0x7E,0x86,0x8E,0x96} },
//Blank 27
        {0x41,2,{0x5A,0x1B} },
        {0x80,16,{0xAA,0x9E,0xA6,0xAE,0xB6,0x55,0xBE,0xC6,0xCE,0xD6,0xA9,0xDE,0xE6,0xF0,0xF7,0xCF} },
...
//Blank 38
        {0x41,2, {0x5A,0x26} },
        {0x80,16, {0x00,0x83,0x00,0xFF,0xFF,0x60,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x85,0x0D} },/*49 02*/
        {0x90,3, {0x5A,0xA5,0x5A} },
...
//INT CANCEL
	...
	{REGFLAG_DELAY, 120, {} },
	{0x51, 2, {0x00, 0x00} },
	{0x53, 1, {0x24} },/*4 enable backlight*/
	{0x55, 1, {0x00} },
	{0x29,0, {} },
	{REGFLAG_END_OF_TABLE, 0x00, {} },
...
{
	LCM_INFO("%s lianchuang ft8006p -> enter power on begin, panel_reset_state=%d\n", __func__, panel_reset_state);
	...
	************************************/
		...
		LCM_INFO("%s lianchuang ft8006p -> enter power on end\n", __func__);
	}
}
...
static void lcm_suspend_power(void)
{
	...
	lcm_enp_setting(0);
	MDELAY(5);
	pr_err("[LCM]lianchuang ft8006p- vddi keep high level\n");/*PD1831 and PD1901 vddi can't shut down*/
	panel_reset_state = 0;// clear reset state
}

static void lcm_init(void)
{
	pr_err("[LCM]lianchuang ft8006p- init begin\n");
	tp_reset_setting(1);
	lcm_reset_setting(1);
	MDELAY(1);
	tp_reset_setting(0);
	...
	panel_off_state = 0;
	pr_err("[LCM]lianchuang ft8006p- init middle, add to trace bug, resume cose 4s\n");
	push_table(init_setting_12bit, sizeof(init_setting_12bit) / sizeof(struct LCM_setting_table), 1);
	pr_err("[LCM]lianchuang ft8006p- init end\n");
}
...
static void lcm_suspend(void)
{
	push_table(lcm_suspend_setting,
		...
		1);
	panel_off_state = 1;
	pr_err("[LCM]lianchuang ft8006p- lcm_suspend display off\n");
}
...
struct LCM_DRIVER pd1901_lianchuang_ft8006p_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd1901_lianchuang_ft8006p_noflash_hdp_dsi_vdo",
