...
/*will_Feng asks to add 0302 1642*/
	{0xFF, 1, {0x25} },
	{0xFB, 1, {0x01} },
	{0xC0, 1, {0x07} },
	{0xCA, 1, {0x1C} },
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_frontporch = 36;  //36
...
static void lcm_init(void)
{
	...
	But PD1901 use no-flash version nt36525, so 15ms is enough, NolenCheng confirmed 0304
	******************************************************************/
	MDELAY(15);
...
struct LCM_DRIVER pd1901_boe_nt36525_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd1901_boe_nt36525_noflash_hdp_dsi_vdo",
