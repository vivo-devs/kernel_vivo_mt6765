...
static struct LCM_setting_table init_setting_12bit[] = {
	...
	{0xF0,16,{0xA0,0x69,0x49,0x66,0xEA,0x28,0x86,0xD0,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0xA4}},
	{0x41,2,{0x5A,0x16}},
	...
	{0x41,2,{0x5A,0x26}},
	{0x80,16,{0x00,0x83,0x00,0xFB,0xBF,0x60,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x29,0xDD}},
...
{
	LCM_INFO("%s BOE ft8006p -> enter power on begin, panel_reset_state=%d\n", __func__, panel_reset_state);
	...
	************************************/
		...
		LCM_INFO("%s BOE ft8006p -> enter power on end\n", __func__);
	}
}
...
static void lcm_init(void)
{
	...
	panel_off_state = 0;
	pr_err("[LCM]BOE ft8006p- init middle, add to trace bug, resume cose 4s\n");
	push_table(init_setting_12bit, sizeof(init_setting_12bit) / sizeof(struct LCM_setting_table), 1);
	pr_err("[LCM]BOE ft8006p- init end\n");
}
...
static void lcm_suspend(void)
{
	push_table(lcm_suspend_setting,
		...
		1);
	panel_off_state = 1;
	pr_err("[LCM]BOE ft8006p- lcm_suspend display off\n");
}
...
struct LCM_DRIVER pd1901_boe_ft8006p_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd1901_boe_ft8006p_noflash_hdp_dsi_vdo",
