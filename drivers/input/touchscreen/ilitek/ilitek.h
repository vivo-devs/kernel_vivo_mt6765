...
extern u32 ilitek_tddi_ic_get_recover_pc_counter(void);
...
/* Prototypes for ViVO */
extern int bbk_ili_get_rawordiff_data(int which, int *data);
extern int bbk_ili_fw_update(const struct firmware *fw);
extern int iliIdleEnableOrDisable(int state);
extern int bbk_ili_readUdd(unsigned char *udd);
extern int bbk_ili_writeUdd(unsigned char *udd);
extern int bbk_ili_mode_change(int which);
extern int bbk_ili_get_fw_version(int which);
extern int bbk_ili_gesture_point_get(u16 *data);
extern int bbk_ili_set_charger_bit(int state);
extern int bbk_ili_read_charger_bit(void);
extern int iliSetEdgeRestainSwitch(int on);
extern int bbk_ili_get_header_file_version(int which, unsigned char *fw);
extern int bbk_ili_get_fw_debug_info(unsigned char *buf);
extern int get_lcm_id(void);
extern int vivo_ili_module_id(void);
extern int bbk_ili_process_by_package(unsigned char * package_name); 
extern int bbk_ili_get_ic_mode(void);
