...
#define CSV_LCM_ON_PATH1			"/data/vendor/touchscreen/com.touchscreen.tptest"
#define CSV_LCM_OFF_PATH		"/sdcard/ilitek_mp_lcm_off_log"
#define INI_NAME_PATH			"/system/etc/ilitek_9881h.ini"
#define UPDATE_FW_PATH			"/sdcard/ILITEK_FW"
#define UPDATE_REQUEST_FW_PATH		"vendor/firmware/"
...
({									\
	pr_info("VIVO_TS_INF: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\

#define ipio_err(fmt, arg...)						\
({									\
	pr_err("VIVO_TS_ERR: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
})									\

extern bool ipio_debug_level_V2;
#define ipio_debug(fmt, arg...)						\
do {									\
	if (ipio_debug_level_V2)						\
	pr_info("VIVO_TS_DEBUG: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
} while (0)
...
#define TOUCH_SCREEN_Y_MAX			1544
...
#define FW_CORE_VER_ADDR			0xFFF0
#define FW_BLOCK_INFO_NUM			7
#define SPI_UPGRADE_LEN				2048
#define SPI_TX_BUF_LEN 				256
...
/* The example for the gesture_V2 virtual keys */
...
struct ilitek_tddi_dev {
	...
	/* Sending report data to users for the debug_V2 */
	...
	struct completion touch_debug_done;
	u8 trans_xy;
	u8  fw_info[75];
	u8  fw_mp_ver[4];
	bool gesture_debug;
	...
	int fw_cmd;
	int spi_mode;
	int low_power_select;
	atomic_t fw_cmd_flag;
	bool mp_mode;
...
extern struct ilitek_tddi_dev *idev_V2;
...
#define ILI_GESTURE_POINT_MAX   6
struct ilitek_gesture_info {
    u16 coordinate_x[ILI_GESTURE_POINT_MAX];
    u16 coordinate_y[ILI_GESTURE_POINT_MAX];
};
...
extern void ilitek_tddi_ic_check_otp_prog_mode_V2(void);
extern void ilitek_tddi_flash_dma_write_V2(u32 start, u32 end, u32 len);
extern void ilitek_tddi_flash_clear_dma_V2(void);
extern void ilitek_tddi_fw_read_flash_info_V2(bool mode);
extern u32 ilitek_tddi_fw_read_hw_crc_V2(u32 start, u32 end);
extern int ilitek_tddi_fw_read_flash(u32 start, u32 end, u8 *data, int len);
extern int ilitek_tddi_fw_dump_iram_data_V2(u32 start, u32 end);
extern int ilitek_tddi_fw_dump_flash_data_V2(u32 start, u32 end, bool user);
extern int ilitek_tddi_fw_upgrade_V2(int upgrade_type, int file_type, int open_file_method);

/* Prototypes for tddi mp test */
extern int ilitek_tddi_mp_test_main_V2(char *apk, bool lcm_on);
/*THP*/
...
extern void ilitek_tddi_gesture_recovery_V2(void);
extern void ilitek_tddi_spi_recovery_V2(void);
extern void ilitek_tddi_touch_esd_gesture_iram_V2(void);
extern int ilitek_tddi_move_gesture_code_flash_V2(int mode);
extern int ilitek_tddi_move_gesture_code_iram_V2(int mode);
extern int ilitek_tddi_move_mp_code_flash_V2(void);
extern int ilitek_tddi_move_mp_code_iram_V2(void);
...
extern void ilitek_tddi_report_ap_mode_V2(u8 *buf, int len, ktime_t kt);
extern void ilitek_tddi_report_debug_mode_V2(u8 *buf, int len, ktime_t kt);
extern void ilitek_tddi_report_gesture_mode_V2(u8 *buf, int rlen);
extern void ilitek_tddi_report_i2cuart_mode_V2(u8 *buf, int rlen);
extern int ilitek_tddi_ic_watch_dog_ctrl_V2(bool write, bool enable);
extern void ilitek_tddi_ic_set_ddi_reg_onepage_V2(u8 page, u8 reg, u8 data);
extern void ilitek_tddi_ic_get_ddi_reg_onepage_V2(u8 page, u8 reg);
extern void ilitek_tddi_ic_spi_speed_ctrl_V2(bool enable);
extern int ilitek_tddi_ic_whole_reset_V2(void);
extern int ilitek_tddi_ic_code_reset_V2(void);
extern int ilitek_tddi_ic_func_ctrl_V2(const char *name, int ctrl);
extern u32 ilitek_tddi_ic_get_pc_counter_V2(void);
extern u32 ilitek_tddi_ic_get_recover_pc_counter_V2(void);
extern int ilitek_tddi_ic_check_int_stat_V2(void);
extern int ilitek_tddi_ic_check_busy_V2(int count, int delay);
extern int ilitek_tddi_ic_get_project_id_V2(u8 *pdata, int size);
extern int ilitek_tddi_ic_get_panel_info_V2(void);
extern int ilitek_tddi_ic_get_tp_info_V2(void);
extern int ilitek_tddi_ic_get_core_ver_V2(void);
extern int ilitek_tddi_ic_get_protocl_ver_V2(void);
extern int ilitek_tddi_ic_get_fw_ver_V2(void);
extern int ilitek_tddi_ic_get_info_V2(void);
extern int ilitek_ice_mode_bit_mask_write_V2(u32 addr, u32 mask, u32 value);
extern int ilitek_ice_mode_write_V2(u32 addr, u32 data, int len);
extern int ilitek_ice_mode_read_V2(u32 addr, u32 *data, int len);
extern int ilitek_ice_mode_ctrl_V2(bool enable, bool mcu);
extern void ilitek_tddi_ic_init_V2(void);
extern void ilitek_tddi_fw_uart_ctrl_V2(u8 ctrl);

/* Prototypes for tddi events */
extern int ilitek_tddi_proximity_far_V2(int mode);
extern int ilitek_tddi_proximity_near_V2(int mode);
extern int ilitek_tddi_switch_mode_V2(u8 *data);
extern int ilitek_tddi_fw_upgrade_handler_V2(void *data);
extern int ilitek_tddi_wq_esd_spi_check_V2(void);
extern void ilitek_tddi_wq_ctrl_V2(int type, int ctrl);
extern int ilitek_tddi_mp_test_handler_V2(char *apk, bool lcm_on);
extern void ilitek_tddi_report_handler_V2(ktime_t kt);
extern int ilitek_tddi_sleep_handler_V2(int mode);
extern int ilitek_tddi_reset_ctrl_V2(int mode);
extern int ilitek_tddi_init_V2(void);
extern void ilitek_tddi_dev_remove_V2(void);

extern int ilitek_spi_write_then_read_split_V2(struct spi_device *spi,
				const void *txbuf, unsigned n_tx,
				void *rxbuf, unsigned n_rx);
extern int ilitek_spi_write_then_read_direct_V2(struct spi_device *spi,
				const void *txbuf, unsigned n_tx,
				void *rxbuf, unsigned n_rx);

/* Prototypes for platform level */
extern void ilitek_plat_regulator_power_on_V2(bool status);
extern void ilitek_plat_input_register(void);
extern void ilitek_plat_irq_disable_V2(void);
extern void ilitek_plat_irq_enable_V2(void);
extern void ilitek_plat_tp_reset_V2(void);

/* Prototypes for miscs */
extern void ilitek_tddi_node_init_V2(void);
extern void ilitek_dump_data_V2(void *data, int type, int len, int row_len, const char *name);
extern u8 ilitek_calc_packet_checksum_V2(u8 *packet, int len);
extern void netlink_reply_msg_V2(void *raw, int size);
extern int katoi_V2(char *str);
extern int str2hex_V2(char *str);

/* Prototypes for ViVO */
extern int bbk_ili_get_rawordiff_data_V2(struct vts_device *vtsdev, enum vts_frame_type which, short *data, int size);
extern int bbk_ili_fw_update_V2(const struct firmware *fw);
extern int iliIdleEnableOrDisable_V2(struct vts_device *vtsdev,int state);
extern int bbk_ili_readUdd_V2(unsigned char *udd);
extern int bbk_ili_writeUdd_V2(unsigned char *udd);
extern int bbk_ili_mode_change_V2(struct vts_device *vtsdev,int which);
extern int bbk_ili_get_fw_version_V2(int which);
extern int bbk_ili_gesture_point_get_V2(u16 *data);
extern int bbk_ili_set_charger_bit_V2(struct vts_device *vtsdev,int state);
extern int bbk_ili_read_charger_bit_V2(void);
extern int iliSetEdgeRestainSwitch_V2(struct vts_device *vtsdev,int on);
extern int bbk_ili_get_header_file_version_V2(int which, unsigned char *fw);
extern int bbk_ili_get_fw_debug_info_V2(unsigned char *buf);
extern int get_lcm_id(void);
extern  int vivo_ili_module_id_V2(struct vts_device *vtsdev);
extern int ilitek_hw_init(struct vts_device *vtsdev);
extern int bbk_ili_process_by_package(unsigned char * package_name); 
...
static inline void firmware_hd_dma_crc_off_ili9881(void)
{
	...
	/* dma crc */
	ilitek_ice_mode_write_V2(0x041048, 0x00000001, 4);
}
